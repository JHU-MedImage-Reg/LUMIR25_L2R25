...
$${\color{red}New!}$$ - 05/06/2024 - Launching the LUMIR challenge at Learn2Reg 2025!
...
- ***Download Validation Dataset:*** Access the validation dataset via Google Drive ([~430MB](https://drive.google.com/uc?export=download&id=1n4nXo2vpm68N1_OIU-15pDSuDQ8LL8vh)).
